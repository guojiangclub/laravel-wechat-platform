<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
        ...
        <form action="{{route('admin.mini.theme.item.update',['id'=>$item->id,'type'=>2])}}" method="post" id="store">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 bars_textarea">
                        ...
                        <textarea  class="form-control" name="param" id="" cols="30" rows="10">{!!$item->param!!}</textarea>
